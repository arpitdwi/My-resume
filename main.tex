  ...
  \resumeSubHeadingListStart
      ...
      \resumeProjectHeading
        ...
        \resumeItemListStart
            ...
            \resumeItem{Carried out knowledge distillation to train compact student models using curriculum learning strategies and deployed these models to production after A/B testing, resulting in over a 10\% improvement in ad quality}
            \resumeItem{Explored architectures with reduced attention complexity like Reformer and Longformer to enable long document understanding in online models with optimal memory usage and latency}
        \resumeItemListEnd
...
\section{Projects and Competitions}
    \resumeSubHeadingListStart
        ...
        \resumeItemListStart
            ...
            \resumeItem{Outperformed strong baselines by more than 10\% on measuring correlation with human judgements}
          \resumeItemListEnd
